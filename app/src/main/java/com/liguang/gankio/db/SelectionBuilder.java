...
/*
 * Modifications:
 * -Imported from AOSP frameworks/base/core/java/com/bootstrap/internal/content
 * -Changed package name
 */

package com.liguang.gankio.db;
...
public class SelectionBuilder {
    ...
    public String toString() {
        return "SelectionBuilder[table=" + mTable + ", selection="
                ...
                + Arrays.toString(getSelectionArgs()) + "projectionMap = "
                + mProjectionMap + " ]";
    }
     ...
     * Execute query using the current internal state as {@code WHERE} clause.
     */
    public Cursor query(SQLiteDatabase db, boolean distinct, String[] columns,
        ...
        return db.query(distinct, mTable, columns, getSelection(),
                getSelectionArgs(), mGroupBy, mHaving, orderBy, limit != null ? limit : mLimit);
    }
    ...
    public SelectionBuilder limit(int pageCount, int page) {
        mLimit = Math.max(0, (page - 1) * pageCount) + "," + pageCount;
        return this;
    }
}
